...
type StoredGame struct {
	...
	CrossPlayer  string `protobuf:"bytes,5,opt,name=crossPlayer,proto3" json:"crossPlayer,omitempty"`
	CirclePlayer string `protobuf:"bytes,6,opt,name=circlePlayer,proto3" json:"circlePlayer,omitempty"`
}
...
func (m *StoredGame) GetIdValue() uint64 {
	if m != nil {
		return m.IdValue
	}
	return 0
...
func (m *StoredGame) GetCrossPlayer() string {
	if m != nil {
		return m.CrossPlayer
	}
	return ""
}

func (m *StoredGame) GetCirclePlayer() string {
	if m != nil {
		return m.CirclePlayer
	}
	return ""
}
...
var fileDescriptor_8439c9c90688ff75 = []byte{
	...
	0x80, 0x33, 0x94, 0x36, 0x30, 0x72, 0x71, 0x05, 0x83, 0x95, 0xbb, 0x27, 0xe6, 0xa6, 0x0a, 0x89,
	...
	,
}
...
func (m *StoredGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CirclePlayer) > 0 {
		i -= len(m.CirclePlayer)
		copy(dAtA[i:], m.CirclePlayer)
		i = encodeVarintStoredGame(dAtA, i, uint64(len(m.CirclePlayer)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.CrossPlayer) > 0 {
		i -= len(m.CrossPlayer)
		copy(dAtA[i:], m.CrossPlayer)
		i = encodeVarintStoredGame(dAtA, i, uint64(len(m.CrossPlayer)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Game) > 0 {
	...
	if m.IdValue != 0 {
		i = encodeVarintStoredGame(dAtA, i, uint64(m.IdValue))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Creator) > 0 {
...
func (m *StoredGame) Size() (n int) {
	...
	if m.IdValue != 0 {
		n += 1 + sovStoredGame(uint64(m.IdValue))
	}
	l = len(m.Game)
	if l > 0 {
		n += 1 + l + sovStoredGame(uint64(l))
...
func (m *StoredGame) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CrossPlayer", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CrossPlayer = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CirclePlayer", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CirclePlayer = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
